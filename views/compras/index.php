                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="number" id="rifProveedor" placeholder="RIF" disabled>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="number" id="totalPagar" placeholder="Total Pagar" disabled>
                        </div>

                        <label>Serie</label>
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-spinner"></i></span>
                            <input class="form-control" type="number" id="serie" onkeypress="return SoloNumeros(event);" maxlength="6" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Serie Compra" required>
                        </div>
