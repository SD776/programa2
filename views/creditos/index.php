    ...
    <div class="card-body">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-creditos-tab" data-bs-toggle="tab" data-bs-target="#nav-creditos" type="button" role="tab" aria-controls="nav-creditos" aria-selected="true">Créditos</button>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-creditos" role="tabpanel" aria-labelledby="nav-creditos-tab" tabindex="0">
                <h5 class="card-title text-center"><i class="fas fa-credit-card"></i> Listado de Créditos</h5>
                <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="number" id="telefonoCliente" placeholder="Telefono" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="number" id="restante" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            ...
                            <input id="monto_total" class="form-control" type="number" placeholder="Monto Total" readonly>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            <label for="monto_abonar">Abonar</label>
                            <input id="monto_abonar" class="form-control" type="number" step="0.01" min="0.01" onkeypress="return SoloNumeros(event);" placeholder="Monto Abonar" required>
                        </div>
                    </div>
                </div>
                <div class="d-grid">
