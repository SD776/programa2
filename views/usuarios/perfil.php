                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if ($data['usuario']['perfil'] == null) {
                            ...
                            <img src="<?php echo $perfil; ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="120">
                            <div class="mt-3">
                                ...
                                <hr>
                                <h5 class="text-center">Fecha de Registro</h5>
                        ...
                        <form id="formularioPerfil" autocomplete="off">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" id="ciPerfil" name="ciPerfil" value="<?php echo $data['usuario']['ci']; ?>" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
